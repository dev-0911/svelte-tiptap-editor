...
type AttrProps = Record<string, string> | ((props: { node: ProseMirrorNode; HTMLAttributes: Record<string, any> }) => Record<string, string>);
...
const SvelteNodeViewRenderer = (component: Component<NodeViewProps>, options?: Partial<SvelteNodeViewRendererOptions>): NodeViewRenderer => {
